...
def build(s):
    ...
    s.pw(U9, "29", ("x", 730.25))                     # OUTA+  (224.79)
    s.pw(U9, "20", ("x", 730.25))                     # OUTB+  (229.87)
    s.w((730.25, 224.79), (730.25, 229.87))
    s.pw(U9, "26", ("x", 725.17))                     # OUTA-  (227.33)
    s.pw(U9, "23", ("x", 725.17))                     # OUTB-  (232.41)
    s.w((725.17, 227.33), (725.17, 232.41))
    L5 = s.L("L5", 749.30, 224.79, "10uH", rot=90)
    s.w((730.25, 224.79), (745.49, 224.79))
    L6 = s.L("L6", 751.84, 241.30, "10uH", rot=90)
    s.pw(L6, "1", ("x", 725.17), ("y", 232.41))
    ...
    for pin, x, ref in [("30", 727.71, "C180"), ("25", 734.06, "C181"),
        ...
        s.C(ref, x, 254.00, "33nF",
            refpos=(x + 1.4, 252.59, "left"), valpos=(x + 1.4, 255.39, "left"))
    s.w((727.71, 257.81), (727.71, 260.35), (740.41, 260.35), (740.41, 257.81))
    s.w((737.87, 260.35), (737.87, 224.79))           # -> OUT+ node
    s.w((734.06, 257.81), (734.06, 262.89), (746.76, 262.89), (746.76, 257.81))
    s.w((744.22, 262.89), (744.22, 241.30))           # -> OUT- node
