...
def build(s):
    ...
    s.w((170.18, 243.84), (209.55, 243.84))          # -> VIN
    ...
    s.pw(L2, "2", ("x", 232.41), ("y", 247.65), ("px", U5, "5"))
    s.gnd(U5, "4")
    ...
    s.pw(C121, "1", ("y", 245.11))
    s.gnd(C121, "2", drop=0)
    C122 = s.C("C122", 248.92, 251.46, "22uF", fp="C0805")
    s.pw(C122, "1", ("y", 245.11))
    s.gnd(C122, "2", drop=0)
    s.power_at(254.00, 241.30, "+5V")
    s.w((254.00, 241.30), (254.00, 245.11))
    s.pwr_flag(264.16, 245.11)
    ...
    s.w((170.18, 317.50), (236.22, 317.50))
    ...
    s.pw(L4, "2", ("x", 269.24), ("y", 318.77), ("px", U7, "1"))
    s.pw(U7, "2", ("x", 269.24))
    s.w((269.24, 318.77), (269.24, 321.31))          # tie both SW pins
    ...
    s.pw(U7, "12", ("x", 271.78))
    s.pw(U7, "13", ("x", 271.78))
    s.w((271.78, 326.39), (271.78, 334.01))
    s.power_at(271.78, 334.01, "GND")
    s.gnd(U7, "14", via=0)
