...
def build(s):
    ...
    s.pw(U2, "5", ("x", 256.54), ("y", 127.00), ("x", 243.84))
    s.glabel_at("FAULT", 243.84, 127.00, 180)
    R13 = s.R("R13", 254.00, 123.19, "10k")
    s.rail(R13, "1", "+3V3", rise=0)
    # TIMER cap
    ...
    C105 = s.C("C105", 341.63, 118.11, "22pF")
