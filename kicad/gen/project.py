"""Write the KiCad project (.kicad_pro), symbol lib table, and all sheet files."""
...
def write_project(name, sheet_uuid_pages):
    pro = {
        ...
        "sheets": sheet_uuid_pages,   # list of [uuid, pagename]
        "text_variables": {},
    }
...
def write_sym_lib_table():
    """Register the local custom symbol lib so lib_id 'clock:*' resolves."""
    txt = (
        "(sym_lib_table\n"
        "\t(version 7)\n"
