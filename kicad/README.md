...
| `BatteryHolder_Keystone_1043_1x18650` | BT1 18650 holder (THM) | resolves the 1042(footprint)↔1043(BOM) mismatch **in favor of the 1043** (TH PC pins, DK 21.9 k stock, $2.99). Body/pegs/index copied from the stock KiCad **1042** footprint (shared molding: diagonal Ø3.45 pegs at ±27.6/∓8, Ø2.39 index at −36.13/−8); PC pins Ø1.19 on the axis at **±35.8** (catalog 2.822″ span; the stalled KiCad MR !2043 used ±36.11) with **Ø2.6 drill / Ø4.2 pad** so either reading fits. ⚠ verify vs the Keystone 1043 drawing before fab |
