...
**Status:** v0.18 draft · **Owner:** you (FW/HW) · **Last updated:** 2026-07-17
...
| ⭐ | USB-C panel extension (port on the enclosure wall) | **Adafruit 6069** — passive C-plug → panel-mount C-jack passthrough (CC intact → 15 V PD works); Ø12–18 mm hole, panels ≤13 mm. *(Do **not** substitute the 6153 pigtail — its built-in 5.1 kΩ CC pull-downs break PD.)* | panel-mount, 175 mm | ~$4.5 | [DigiKey ✅](https://www.digikey.com/en/products/detail/adafruit-industries-llc/6069/25897275) |
...
| 2026-07-17 | **USB-C port moved to the enclosure wall — Adafruit 6069 panel-mount extension**; on-board USB4105 + CH224K unchanged | Passive C-plug→panel-C-jack passthrough keeps CC continuity → 15 V PD negotiation intact ([DigiKey 25897275](https://www.digikey.com/en/products/detail/adafruit-industries-llc/6069/25897275), ~$4.50). The wired 6-pin pigtail route (Adafruit 6153) was rejected: its **built-in 5.1 kΩ CC pull-downs** parallel the CH224K's Rd → PD falls back to 5 V and the LT3652 (UVLO 11.2 V) would never charge |
