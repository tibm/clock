...
| ⭐ | USB-C recept (**vertical**, power+CC+D±) | **Same Sky UJ20-C-V-C-2-SMT-TR** (USB 2.0 Type-C, 16-pin, **TH pins** — stands on the PCB → port exits the back wall; H 10 mm; ⚠ **backorder at DigiKey 2026-07-19**, active). In-stock SMT alt: **GCT USB4145-03-0170-C** ($1.05, 1.70 mm stakes). *Replaces the horizontal USB4105 + Adafruit 6069 extension; USB4140 (no D±) and UJ20-C-V-C-**1** (0.8 mm-PCB legs) rejected.* | TH vertical, 16 pins + 4 stake slots | ~$0.95 | [DigiKey ✅](https://www.digikey.com/en/products/detail/same-sky-formerly-cui-devices/UJ20-C-V-C-2-SMT-TR/24766932) · [alt](https://www.digikey.com/en/products/detail/gct/USB4145-03-0170-C/16649098) |
...
- **USB-C receptacle:** **Same Sky UJ20-C-V-C-2-SMT-TR** ⭐ (vertical, 16-pin, **TH pins**, D±+CC — backorder 2026-07-19) / GCT **USB4145-03-0170-C** (in-stock SMT alt, 1.70 mm stakes) / USB4140 & UJ20-C-V-C-1 (rejected: power-only resp. 0.8 mm-PCB legs) / USB4105-GF-A + Adafruit 6069 extension (the superseded horizontal + panel-remote combo).
