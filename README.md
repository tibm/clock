...
| 2026-07-17 | **UI moved off-board: EC11 encoder + 3 buttons → J10** (JST SH 1×08, SM08B-SRSS-TB, [DigiKey 926714](https://www.digikey.com/en/products/detail/jst-sales-america-inc/SM08B-SRSS-TB/926714), ~$0.80) | Encoder/buttons mount on the enclosure, not the PCB → placement freedom in the wooden case; same connector family as the sensor board J7 (cheap pre-crimped SH cables). Pinout: 1 GND · 2 ENC_A · 3 ENC_B · 4–6 BTN1-3 · 7 ENC_SW · 8 GND. Switch lines keep MCP23017 internal pull-ups; A/B keep on-board 10 k pull-ups |
