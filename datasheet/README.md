...
| 9 | `battery_protector_hy2111.pdf` | **HY2111-GB** (OV 4.28 V / OD 2.90 V) | HYCON | **SOT-23-6** | ✅ *(LCSC)* | ~$0.09 | none (autonomous) |
...
## 9. HYCON HY2111-GB + 10. Alpha & Omega AOSD32334C — 1-Cell Protector *(independent safety)*
...
- **Price:** ~$0.09 (HY2111-GB, LCSC qty 5) + ~$0.28 (AOSD32334C).
- **Power / IO:** the protector monitors cell voltage/current and drives the two series FETs (charge + discharge) via its **OC/OD** pins in the cell **−** path. **HY2111 (-GB):** overcharge **4.28 V**, over-discharge **2.90 V**, discharge-overcurrent **150 mV** + load-short (0.85 V) + charge-overcurrent (−100 mV) detection, all delays internal — **autonomous, no config**. VDD abs-max 10 V, CS/OC to VDD−20 V (cell node never sees VBUS — fine). **AOSD32334C:** VDS 30 V, VGS ±20 V, low Rds(on), continuous current (7 A) far above our <2 A.
