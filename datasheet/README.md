...
| 34 | `connector_jst_zh.pdf` | **JST ZH series** (1.5 mm, 1 A): **B6B-ZR** ×2 (J7 sensor, J10 knob) + **B2B-ZR** (J11 toggle), TH top-entry; mates the pre-crimped **A06ZR06ZR28H102B**-style ZH↔ZH cables | JST | **TH vertical, 1.5 mm** | ✅ [DK search](https://www.digikey.com/en/products/result?keywords=B6B-ZR) | ~$0.2–0.3 ea | off-board harnesses (sensor/knob/toggle) |
